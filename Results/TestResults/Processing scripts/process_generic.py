...
folder_path= 'Results\\TestResults\\ED_WL'
...
for file_name in os.listdir(folder_path):
        ...
        if os.path.isfile(file_path):
            ...
            data[c_value]['w'] = p1_wins / len(p1_scores)
            data[c_value]['l'] = (len(p1_scores) - p1_wins) / len(p1_scores)
# print(data)
print(data[c_value]['p1'])
print(data[c_value]['p2'])
print(data[c_value]['w'])
print(data[c_value]['l'])
