...
if __name__ == "__main__":
    ...
    tests = [
        ...
        {'name': 'CValueTests','function':c_value_test, 'mode':'paralel', 'result_size':100, 
         'param': [i for i in range(5, 21)]}
        # {'name': 'ED_VS','function':ed_vs, 'mode':'simple', 'result_size':50, 
        #  'param': [manager]},
        # {'name': 'ED_WL','function':ed_wl, 'mode':'simple', 'result_size':50, 
        # 'param': [manager]},
        # {'name': 'EDTimeTests','function':ed_time_test, 'mode':'simple', 'result_size':50, 
        # 'param': [manager]},
        # {'name': 'LIM_ED','function':lim_ed, 'mode':'simple', 'result_size':50, 
        # 'param': [manager]},
        ...
        # {'name': 'MCTS_ED','function':mcts_ed, 'mode':'simple', 'result_size':50, 
        #  'param': [manager]},
        ...
        #  'param': [1]},
        # {'name': 'MCTSTimeTests','function':mcts_time_test, 'mode':'simple', 'result_size':100, 
        #  'param': [1]},
        # {'name': 'Random_ED','function':random_ed, 'mode':'simple', 'result_size':50, 
        #  'param': [manager]},
